...
//--------------------------------------------------------------
void SingleGame::update(int& scene){
	...
	if(b_p1Choosed == true && b_p2Choosed == true && bStageChoosed == true) //game前置動作已完成
	{
		...
		{	//game start
			bGameChoosed = true;
			_cpuGame.setup(p1,p2,arena,first);
		}
		else
        {
             _cpuGame.update();
             if(_cpuGame.getbcpuGameFinished()){ //若遊戲結束...
				//reset
                p1 = 0,p2 = 0,arena = 0;
                bGameChoosed = false;
                b_p1Choosed = false;
...
//--------------------------------------------------------------
void SingleGame::draw(int& scene){
...
//--------------------------------------------------------------
void SingleGame::keyPressed(int key,int& scene){
	if(b_p1Choosed == true && b_p2Choosed == true && bStageChoosed ==true)
		_cpuGame.keyPressed(key);
}

//--------------------------------------------------------------
void SingleGame::keyReleased(int key,int& scene){
	if(b_p1Choosed == true && b_p2Choosed == true && bStageChoosed==true)
		_cpuGame.keyReleased(key);
}

//--------------------------------------------------------------
void SingleGame::mouseMoved(int x, int y,int& scene){
	if(b_p1Choosed == true && b_p2Choosed == true && bStageChoosed==true)
		_cpuGame.mouseMoved( x, y);
}

//--------------------------------------------------------------
void SingleGame::mouseDragged(int x, int y, int button,int& scene){
	if(b_p1Choosed == true && b_p2Choosed == true && bStageChoosed==true)
		_cpuGame.mouseDragged(x, y, button);

}

//--------------------------------------------------------------
void SingleGame::mousePressed(int x, int y, int button,int& scene){
	if(b_p1Choosed == false || b_p2Choosed == false || bStageChoosed == false) //option
	{
	...
	if(bGameChoosed == true)
		_cpuGame.mousePressed(x,y,button);
}
//--------------------------------------------------------------
void SingleGame::mouseReleased(int x, int y, int button,int& scene){
	if(b_p1Choosed == true && b_p2Choosed == true && bStageChoosed==true)
		_cpuGame.mouseReleased(x,y, button);
}

//--------------------------------------------------------------
void SingleGame::windowResized(int w, int h,int& scene){
	if(b_p1Choosed == true && b_p2Choosed == true && bStageChoosed==true)
		_cpuGame.windowResized(w, h);
}

//--------------------------------------------------------------
void SingleGame::gotMessage(ofMessage msg,int& scene){
	if(b_p1Choosed == true && b_p2Choosed == true && bStageChoosed==true)
		_cpuGame.gotMessage( msg);
}

//--------------------------------------------------------------
void SingleGame::dragEvent(ofDragInfo dragInfo,int& scene){
	if(b_p1Choosed == true && b_p2Choosed == true && bStageChoosed==true)
		_cpuGame.dragEvent(dragInfo);
}
